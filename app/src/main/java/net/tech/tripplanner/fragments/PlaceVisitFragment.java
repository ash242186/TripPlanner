...
public class PlaceVisitFragment extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        Log.e(TAG, "onStart");
        ((POIActivity)getActivity()).updateToolbarTitle(R.string.title_placevisit);
        if (response != null) {
            loading = false;
            onLoadingShow(false);
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if ((!loading && (totalItemCount - visibleItemCount)
                ...
                if (getActivity() instanceof POIActivity && response != null) {
                    ((POIActivity) getActivity()).pagePlaceRequest("Places To Visit", (POIActivity.limit + previousTotal));
                } else {
